  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} showCloseButton>
      { isError
        ...
        : (
            <div className="flex flex-col md:w-[480px] w-[300px] items-center justify-center gap-6 px-14 py-10 mt-6">
              <div className="flex flex-col content-between items-center gap-2">
                <div className="text-2xl text-center font-semibold text-dark-500">Your voting power has been increased</div>
