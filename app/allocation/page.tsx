      ...
      <div className="flex flex-col gap-6 p-16">
        {!allocatingBudget && (
          <div className="flex flex-col gap-3 max-w-[65%]">
            ...
            <p className="bg-[#FFFAEB] p-4 mt-4 rounded-xl text-dark-500">
        ...
        <div className="flex justify-between gap-4">
          <div className="flex flex-col gap-6 rounded-xl border p-6 max-w-[65%]">
            <div>
              ...
              <div className="flex flex-col justify-between">
                ...
                {allocatingBudget && (
                  <div className="my-6 flex items-center gap-4">
                    ...
                    />
                    <span> 8M </span>
                    <div className="w-64 whitespace-nowrap border bg-gray-50 py-2 text-center text-sm text-gray-500 rounded-md">
                      {(totalValue * 1_000_000).toLocaleString()} OP
                    </div>
                    <button
                      onClick={() => {}}
            ...
            {allocatingBudget ? (
              <div className="flex justify-between">
                <button
                  className="flex rounded-lg border px-4 py-2 text-gray-700 bg-gray-50 font-semibold justify-center items-center gap-3"
                  onClick={() => setAllocatingBudget(false)}
                >
                  <ArrowLeft2Icon />
                  Back to Categories
                </button>
                <button className="flex rounded-lg bg-primary px-10 py-2 text-white font-semibold justify-center items-center gap-3">
                  Submit Vote
