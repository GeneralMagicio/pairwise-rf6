...
export const mockProject1: IProject = {
  ...
  parentId: 1,
  image: 'https://storage.googleapis.com/op-atlas/973ba7db-8101-405b-98a0-1f7d93a0f344.png',
  // @ts-ignore
  metadata: {
    ...
    description:
      'Lodestar is a Typescript ecosystem for Ethereum consensus, developed by ChainSafe Systems. Our flagship products are our production-capable beacon chain and validator client. In addition, we maintain public repositories of useful tools for public use. Some of these libraries include JS implementations for BLS, SSZ, Discv5, Gossipsub, Noise and Yamux. Our work contributes to the backbone infrastructure required to keep the Ethereum blockchain progressing within the rules as defined by the specification.\n\nLodestar’s niche is in its implementation language, TypeScript. Our software and tooling is uniquely situated as the go-to for researchers and developers for rapid prototyping such as our Prover, a verified web3 provider using light clients to increase decentralization and security of the JSON-RPC. Millions of developers around the world are familiar with Typescript, and Lodestar’s high-quality codebases are excellent introductions to the Ethereum protocol, with the goal of increasing client diversity and attracting new talent from one of the largest groups of developers in the world.',
    profileAvatarUrl: 'https://storage.googleapis.com/op-atlas/973ba7db-8101-405b-98a0-1f7d93a0f344.png',
    projectCoverImageUrl: 'https://storage.googleapis.com/op-atlas/3bb2834a-dcfd-4a71-ae2f-1e4fbef4209c.png',
    socialLinks: {
      website: [
    ...
    links: [
      ...
      },
      {
        ...
        description: 'This page represents the distribution of various user agents within the Ethereum discv5 DHT.',
      },
      {
        url: 'https://npm-stat.com/charts.html?package=%40chainsafe%2Flodestar&from=2021-06-26&to=2024-08-26',
        name: 'NPM Download Stats',
        description: 'This mono-repository contains a suite of Ethereum Consensus packages.',
      },
    ],
    contracts: [],
    grantsAndFunding: {
        ...
        create: [
          {
            ...
            question: 'How does your project support, or is a dependency of, the OP Stack?',
          },
          {
            answer:
...
export const mockProject2: IProject = {
  ...
  parentId: 1,
  image: 'https://storage.googleapis.com/op-atlas/d7cf4059-4f9c-48aa-a37a-df2f8c81933c.png',
  // @ts-ignore
  metadata: {
    ...
    organization: {
      ...
      description: 'Ethereum Foundation team dedicated at developing Formal Verification Tools for Ethereum Smart Contracts',
      organizationAvatarUrl: 'https://storage.googleapis.com/op-atlas/5b371001-feaf-4002-8671-c4314150460c.png',
    ...
    description:
      'hevm is an open source, state-of-the art, fast symbolic and concrete EVM execution engine. It has a library interface and can be used as a component in high level tooling. It can be used stand-alone for ad-hoc analysis and symbolic unit test execution.',
    profileAvatarUrl: 'https://storage.googleapis.com/op-atlas/d7cf4059-4f9c-48aa-a37a-df2f8c81933c.png',
    projectCoverImageUrl: 'https://storage.googleapis.com/op-atlas/020d34f6-e8bb-43b5-8508-7935d2b00583.png',
    socialLinks: {
    ...
    team: [
      {
        fid: 843949,
        object: 'user',
        pfp_url: 'https://imagedelivery.net/BXluQx4ige9GuW0Ia56BHw/3c06e9f4-a279-46c8-95ca-8f442b82a800/rectcrop3',
        profile: { bio: { text: '' } },
        username: 'zoepar',
        power_badge: false,
      ...
      },
      {
        fid: 844134,
        object: 'user',
        pfp_url: 'https://imagedelivery.net/BXluQx4ige9GuW0Ia56BHw/2ecdf9e0-8529-4ed6-716f-ecb9b6087600/rectcrop3',
        profile: {
        ...
        active_status: 'inactive',
        verifications: ['0x5e8c31a0fdc254703aa47f6a56acc841c7695f6c', '0x5e8c31a0fdc254703aa47f6a56acc841c7695f6c'],
        follower_count: 1,
        custody_address: '0xaa0a0e3ea0377a068f5ddd1a97b88d37397d41ea',
        following_count: 0,
        verified_addresses: {
          eth_addresses: ['0x5e8c31a0fdc254703aa47f6a56acc841c7695f6c', '0x5e8c31a0fdc254703aa47f6a56acc841c7695f6c'],
          sol_addresses: [],
        },
      },
      {
        fid: 845018,
        object: 'user',
        pfp_url: 'https://imagedelivery.net/BXluQx4ige9GuW0Ia56BHw/7687568d-7499-457f-3d33-4457de55a800/rectcrop3',
        profile: { bio: { text: '' } },
        username: 'blishko',
        power_badge: false,
      ...
      },
      {
        fid: 848682,
        object: 'user',
        pfp_url: 'https://imagedelivery.net/BXluQx4ige9GuW0Ia56BHw/d1157019-9a42-4db6-5c83-4082c1343e00/rectcrop3',
        profile: { bio: { text: '' } },
        username: 'dxo-',
        power_badge: false,
        display_name: 'dxo',
